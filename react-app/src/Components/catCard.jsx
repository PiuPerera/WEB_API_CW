        ...
        return (
            <React.Fragment>
                <div className="card" style={{width: "18rem", marginTop:"20px"}}>
                    <img className="card-img-top" src={this.props.cat.image} alt=".." height="200px" style={{objectFit: "cover", objectPosition: "center"}}/>
                    <div className="card-body">
                        ...
                        <a href="/view" className="btn btn-primary">View More</a>
                        ...
                        <img src="./images/thumb_up_FILL0_wght400_GRAD0_opsz48.png" width="20px" height="20px" onClick={this.props.onLike} style={{marginLeft: "30px"}} alt=".."></img>
                        <span className="badge bg-light" style={{color: "black"}}>{this.props.cat.likeCount}</span>
                        <img src="./images/thumb_down_FILL0_wght400_GRAD0_opsz48.png" width="20px" height="20px" onClick={this.props.onLike} style={{marginLeft: "10px"}} alt=".."></img>
                        <span className="badge bg-light" style={{color: "black"}}>{this.props.cat.likeCount}</span>
                    </div>
                </div>
            </React.Fragment>
